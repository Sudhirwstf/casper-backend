# # #!/usr/bin/env python3
# # """
# # Enhanced Multi-Platform Social Media Optimizer - Command Line Orchestration
# # A comprehensive tool for optimizing images and content across multiple social media platforms,
# # now with integrated product photography generation.
# # """
...
# #     """Enhanced command-line orchestrator for multi-platform social media optimization with product photography"""
...
# #         self.save_enhanced_results(results, content_description, user_description, image_path, detection_data, product_images)
        
# #         return results
    
# #     def save_enhanced_results(self, results: Dict[str, dict], content_description: str, 
# #                             user_description: Optional[str], image_path: str, 
# #                             detection_data: Dict[str, any], product_images: Dict[str, str]):
# #         """Save enhanced optimization results to JSON files with product photography info"""
...
# #                 # Save individual platform JSON
# #                 platform_file = json_output_dir / f"{platform}_{self.session_id}_{timestamp}.json"
...
# #         combined_file = json_output_dir / f"combined_{self.session_id}_{timestamp}.json"
...
# #         """Print a summary of optimization results with product photography info"""
# #         print("\n" + "="*80)
...
# #         description="Enhanced Multi-Platform Social Media Optimizer with Product Photography - Optimize images and content for multiple social platforms",
...
#     from photography import ProductPhotoGenerator
#     from logo import add_logo_to_image
#     from compiler import SocialMediaCaptionCompiler  # Import compiler
# except ImportError as e:
#     print(f"❌ Error importing custom modules: {e}")
#     print("Make sure all required modules are in the same directory as this script.")
#     sys.exit(1)
...
#                 if "combined_" in os.path.basename(json_file):
#                     continue
...
#         json_files = [str(f) for f in json_files if not f.name.startswith("combined_")]
